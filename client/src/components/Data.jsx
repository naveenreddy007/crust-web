          ...
          <table className="min-w-full table-auto text-sm text-gray-200">
            <thead>
              <tr className="bg-gray-700 bg-opacity-50 text-gray-200">
                ...
                <th className="px-2 md:px-4 py-2 md:py-3 text-left">Business Name</th>
                <th className="px-2 md:px-4 py-2 md:py-3 text-left">Turnover</th>
            ...
            <tbody>
              {formData.map((form, index) => (
                ...
                >
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2">{index + 1}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2">{form.rmName}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2">{form.customerFullName}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2 text-blue-300">{form.email}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2 text-green-300">{form.phoneNumber}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2 text-yellow-300">{form.typeOfIncome}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2 text-yellow-300">{form.businessName}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2 text-purple-300">{form.businessTurnover}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2 text-purple-300">{form.existingLoans}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2 text-purple-300">{form.loanRequirement}</td>
                  <td className="border-t border-gray-600 px-2 md:px-4 py-1 md:py-2 text-purple-300">{form.typeOfLoan}</td>
